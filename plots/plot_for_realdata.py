...
# Add horizontal dotted line at the start of the exponential phase
#plt.plot([10, 16], [sigmoid(10, L, x0_1, k1), sigmoid(16, L, x0_1, k1)], 'k--', lw=0.5)

# Add a horizontal line at y=0.1
plt.axhline(y=0.1, color='grey', linestyle='--')

# Annotate the points where the curves meet the dotted line at y=1
